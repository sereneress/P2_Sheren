...
<form action="{{ isset($Pasien)
        ? route('Pasien.update', $Pasien->kode_pasien)
        : route('Pasien.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"
                        value="{{ old('kode_pasien', $Pasien->kode_pasien ?? $kode ?? '') }}" readonly>

                    <input type="hidden" name="kode_pasien"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="umur" class="form-control" value="{{ old('umur', $Pasien->umur ?? '') }}"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="status_kunjungan" class="form-control" required>
                        @php
                        $statusList = ['draft','antrian','pemeriksaan','ambil obat','selesai'];
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('Pasien.pasien') }}" class="btn btn-secondary ms-2">
                        Kembali
                    </a>
                </div>
